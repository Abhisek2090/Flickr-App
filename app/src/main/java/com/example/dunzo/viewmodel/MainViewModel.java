...
import com.example.dunzo.repo.MainRepository;
...
public class MainViewModel extends AndroidViewModel {
    ...
    private static final String DEFAULT_SEARCH_STRING = "cars"; //Default search string. It returns some really nice images ;)
    ...
    private MainRepository mMainModel;
    ...
    public MainViewModel(@NonNull Application application) {
        super(application);
        mMainModel = new MainRepository(application);
    }
